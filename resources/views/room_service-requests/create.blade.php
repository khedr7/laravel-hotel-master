@extends('layouts.app', ['activePage' => 'create-room-service-requests', 'titlePage' => __('Service Requests')])
...
@section('content')
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form method="POST" action="{{ route('admin.room-service-requests.store') }}" autocomplete="off" class="form-horizontal" enctype="multipart/form-data">
                        @csrf
                        @method('post')
                        <div class="card ">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('room-service-name') ? ' has-danger' : '' }}">
                                            ...
                                            <select name="room_service_id" id="roomservice_id" class="custom-select" data-live-search="true" data-default="{{ old('roomservice_id') }}">
                                               ...
                                               @endforeach
                                               <option value="null" selected="selected">Select room service</option>
                                           </select>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('Employee-name') ? ' has-danger' : '' }}">
                                            ...
                                            <select name="employee_id" id="employee_id" class="custom-select" data-live-search="true" data-default="{{ old('employee_id') }}">
                                                    ...
                                                    @endforeach
                                                    <option value="null" selected="selected">Select employee</option>
                                                </select>
                                        </div>
                                    </div>
                                </div>
